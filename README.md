...
1)Update java version in project structure. if using other java versions (I am using java 17)   please do step 2 as well
...
2) If using java 17 please skil this step. If using other java versions example 1.8 please change pom.xml below to the specific java version
