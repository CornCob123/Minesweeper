...
1) Recommended to use Java 17 ,change project structure in these locations. if using other version please do the following step as well
...
2) If using other version of java example 1.8 change pom.xml below to the specific java version

![image](https://github.com/user-attachments/assets/e29f7a8e-30b8-4e01-9285-6291b9a5cba2)

3) download lombok plugin from marketplace follow below screenshot
